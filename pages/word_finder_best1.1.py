        ...
        if any(filename.endswith(ext) for ext in extensions):
            ...
            if filename.endswith(".txt"):
                ...
                with open(file_path, "r", encoding="utf-8") as file:
                    ...
                    matches = find_keyword_in_lines(lines, keyword, file_path)
                    if matches:
...
def find_keyword_in_lines(lines, keyword, file_path):
    """
    Searches for all instances of a keyword in a list of lines and highlights them.
        ...
        if results:
            ...
            for file, matches in results.items():
                ...
                for match in matches:
                    ...
                    # Display clickable link to the file
                    st.markdown(
