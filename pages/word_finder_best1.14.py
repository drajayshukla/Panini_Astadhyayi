        ...
        if any(filename.endswith(ext) for ext in extensions):
            ...
            if filename.endswith(".txt"):
                ...
                with open(file_path, "r", encoding="utf-8") as file:
                    ...
                    matches = find_keyword_in_lines(lines, keyword, filename, lines_before, lines_after)
                    if matches:
...
def find_keyword_in_lines(lines, keyword, filename, lines_before=1, lines_after=2):
    """
    Searches for all instances of a keyword in a list of lines and extracts surrounding lines.
