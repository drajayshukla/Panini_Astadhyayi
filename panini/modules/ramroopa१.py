...
def decline_word(word, suffixes):
    ...
    for case, endings in suffixes.items():
        declined_forms[case] = [merge_characters(word[:-1] + ending) for ending in endings]

    return declined_forms

# Your existing code to generate input_string and output_string...
...
# Word input
word = output_string  # Replace with any word from the input

# Generate declined forms
declined_forms = decline_word(word, suffixes)

# Print the final merged forms
