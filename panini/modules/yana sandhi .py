...
output_string_10 = separate_characters_and_map(input_string)
print('characters separation:', output_string_10)
import sys
def replace_characters(words):
    ...
    #characters_to_replace = ['इ', 'उ', 'ऋ', 'लृ']
    #replacement_characters = ['य्', 'व्', 'र्', 'ल्']
    if first_word[-1] in characters_to_replace and second_word[0] in ['अ', 'इ', 'उ', 'ऋ', 'लृ', 'ए', 'ओ', 'ऐ', 'औ']:

        if first_word[-1] == 'ऌ':
                new_first_word = 'ल्'
        elif first_word[-1] in characters_to_replace:
        ...
        return result
            ...
            print('not yana sandhi')
            sys.exit()



# Example usage
input_words = output_string_10
        #"ऌ आक्ऋत्इः"
...
# Example usage
#input_words =result
        #input("Enter two words separated by a space: ")
#result_1 = remove_space(input_words)
...
#input_word =\
        #input("Enter a word: ")
result_11 = merge_characters(result)
print("Result:", result_11)
