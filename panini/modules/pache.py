...
print('डुपचष् पाके=पचँष् लँट्,यजँ लँट्')
print('कर्तरि लट्लकारः (आत्मनेपदम्)')
print('इट् = आत्मनेपदम् + उत्तमपुरुषः + एकवचनम्')
print('यजँ देवपूजासङ्गतिकरणदानेषु=यजँ लिँट् ')
print('कर्तरि लिट्लकारः (आत्मनेपदम्)')
